<footer class="footer footer-2">
    ...
    <div class="footer-newsletter bg-image"
        style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/backgrounds/bg-2.jpg)">
        <div class="container">
                        ...
                        <ul class="nav nav-pills nav-fill" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="signin-tab" data-toggle="tab"
                                    href="<?php echo get_template_directory_uri(); ?>/#signin" role="tab"
                                    aria-controls="signin" aria-selected="true">Sign In</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="register-tab" data-toggle="tab"
                                    href="<?php echo get_template_directory_uri(); ?>/#register" role="tab"
                                    ...
                                    <div class="form-footer">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="register-policy">I agree to the
                                                <a href="<?php echo get_template_directory_uri(); ?>/#">privacy
                                                    policy</a> *</label>
                                        </div><!-- End .custom-checkbox -->
                                    </div><!-- End .form-footer -->
                                </form>
