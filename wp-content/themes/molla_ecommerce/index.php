...
<main class="main">
    ...
    <div class="brands-border owl-carousel owl-simple" data-toggle="owl" data-owl-options='{
        ...
        <a href="<?php echo get_template_directory_uri(); ?>/#" class="brand">
                    ...
                    <div class="row justify-content-center">
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    ...
                                    <a href="<?php echo get_template_directory_uri(); ?>/product.html">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/demos/demo-2/products/product-9-1.jpg"
                                            alt="Product image" class="product-image">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/demos/demo-2/products/product-9-2.jpg"
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a
                                            href="<?php echo get_template_directory_uri(); ?>/product.html">Garden
                                            Armchair</a></h3>
                                    <!-- End .product-title -->
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    ...
                                    <a href="<?php echo get_template_directory_uri(); ?>/product.html">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/demos/demo-2/products/product-12-1.jpg"
                                            alt="Product image" class="product-image">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/demos/demo-2/products/product-12-2.jpg"
                                            alt="Product image" class="product-image-hover">
                                    </a>
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a
                                            href="<?php echo get_template_directory_uri(); ?>/product.html">2-Seater</a>
                                    </h3>
                                    <!-- End .product-title -->
                                    <div class="product-price">
                                        $3.107,00
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="<?php echo get_template_directory_uri(); ?>/product.html">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/demos/demo-2/products/product-13-1.jpg"
                                            alt="Product image" class="product-image">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/demos/demo-2/products/product-13-2.jpg"
                                            alt="Product image" class="product-image-hover">
                                    </a>
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a
                                            href="<?php echo get_template_directory_uri(); ?>/product.html">Wingback
                                            Chair</a></h3>
                                    <!-- End .product-title -->
                                    <div class="product-price">
                                        $2.486,00
                    ...
                    <div class="row justify-content-center">
                        <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="<?php echo get_template_directory_uri(); ?>/product.html">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/demos/demo-2/products/product-8-1.jpg"
                                            alt="Product image" class="product-image">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/demos/demo-2/products/product-8-2.jpg"
                                            alt="Product image" class="product-image-hover">
                                    </a>
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a
                                            href="<?php echo get_template_directory_uri(); ?>/product.html">Madra
                                            Log Holder</a></h3>
                                    <!-- End .product-title -->
                                    <div class="product-price">
                                        $401,00
                                    ...
                                    <div class="product-nav product-nav-dots">
                                        <a href="<?php echo get_template_directory_uri(); ?>/#" class="active"
                                            style="background: #333333;"><span class="sr-only">Color
                                                name</span></a>
                                        <a href="<?php echo get_template_directory_uri(); ?>/#"
                                            style="background: #927764;"><span class="sr-only">Color
                                                name</span></a>
                                    </div><!-- End .product-nav -->
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="<?php echo get_template_directory_uri(); ?>/product.html">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/demos/demo-2/products/product-11-1.jpg"
                                            alt="Product image" class="product-image">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/demos/demo-2/products/product-11-2.jpg"
                                            alt="Product image" class="product-image-hover">
                                    </a>
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a
                                            href="<?php echo get_template_directory_uri(); ?>/product.html">Original
                                            Outdoor
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="<?php echo get_template_directory_uri(); ?>/product.html">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/demos/demo-2/products/product-14-1.jpg"
                                            alt="Product image" class="product-image">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/demos/demo-2/products/product-14-2.jpg"
                                            alt="Product image" class="product-image-hover">
                                    </a>
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a
                                            href="<?php echo get_template_directory_uri(); ?>/product.html">Cushion
                                            Set 3 Pieces</a>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="<?php echo get_template_directory_uri(); ?>/product.html">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/demos/demo-2/products/product-15-1.jpg"
                                            alt="Product image" class="product-image">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/demos/demo-2/products/product-15-2.jpg"
                                            alt="Product image" class="product-image-hover">
                                    </a>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="<?php echo get_template_directory_uri(); ?>/product.html">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/demos/demo-2/products/product-7-1.jpg"
                                            alt="Product image" class="product-image">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/demos/demo-2/products/product-7-2.jpg"
                                            alt="Product image" class="product-image-hover">
                                    </a>
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a
                                            href="<?php echo get_template_directory_uri(); ?>/product.html">Petite
                                            Table Lamp</a></h3>
                                    <!-- End .product-title -->
                                    <div class="product-price">
                                        $401,00
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="<?php echo get_template_directory_uri(); ?>/product.html">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/demos/demo-2/products/product-10-1.jpg"
                                            alt="Product image" class="product-image">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/demos/demo-2/products/product-10-2.jpg"
                                            alt="Product image" class="product-image-hover">
                                    </a>
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a
                                            href="<?php echo get_template_directory_uri(); ?>/product.html">Carronade
                                            Large Suspension
                                    ...
                                    <div class="product-nav product-nav-dots">
                                        <a href="<?php echo get_template_directory_uri(); ?>/#" class="active"
                                            style="background: #e8e8e8;"><span class="sr-only">Color
                                                name</span></a>
                                        <a href="<?php echo get_template_directory_uri(); ?>/#"
                                            style="background: #333333;"><span class="sr-only">Color
                                                name</span></a>
                        ...
                        <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="<?php echo get_template_directory_uri(); ?>/product.html">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/demos/demo-2/products/product-16-1.jpg"
                                            alt="Product image" class="product-image">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/demos/demo-2/products/product-16-2.jpg"
                                            alt="Product image" class="product-image-hover">
                                    </a>
